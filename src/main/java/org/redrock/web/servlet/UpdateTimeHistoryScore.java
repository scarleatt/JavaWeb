...
@WebServlet(name = "UpdateTimeHistoryScore", value = "/updateTimeHistoryScore")
public class UpdateTimeHistoryScore extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse res)
        ...
        try {
            ...
            try (Connection conn=JdbcUtil.getConnection()) {
                String sql = "select tScore from funfest where stuid="+"\""+stuid+"\"";
